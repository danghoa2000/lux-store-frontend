...
const AdminLoginContainer = lazy(() =>
  LazyRetry(() => import("./src/page/admin/login/LoginContainer"))
);
const AdminHomeContainer = lazy(() =>
  LazyRetry(() => import("./src/page/admin/home/HomeContainer"))
);

const AdminCategoryContainer = lazy(() =>
  LazyRetry(() => import("./src/page/admin/categories/CategoryContainer"))
);
...
const AdminAccountContainer = lazy(() =>
  LazyRetry(() => import("./src/page/admin/account/AccountContainer"))
);
...
const AdminManufacturerContainer = lazy(() =>
  LazyRetry(() => import("./src/page/admin/manufacturer/ManufacturerContainer"))
);
...
const AdminProductContainer = lazy(() =>
  LazyRetry(() => import("./src/page/admin/product/ProductContainer"))
);
...
const AdminShippingContainer = lazy(() =>
  LazyRetry(() => import("./src/page/admin/shipping/ShippingContainer"))
);
const AdminEventContainer = lazy(() =>
  LazyRetry(() => import("./src/page/admin/event/EventContainer"))
);
const AdminOrderContainer = lazy(() =>
  LazyRetry(() => import("./src/page/admin/order/OrderContainer"))
);
const AdminOrderDetailContainer = lazy(() =>
  LazyRetry(() => import("./src/page/admin/order/detail/OrderDetailContainer"))
);

const AdminCouponContainer = lazy(() =>
  LazyRetry(() => import("./src/page/admin/coupon/CouponContainer"))
);
...
const HomePageContainer = lazy(() =>
  LazyRetry(() => import("./src/page/client/HomePageContainer"))
);
const CartContainer = lazy(() =>
  LazyRetry(() => import("./components/partial/Cart/Cart"))
);
const DetailContainer = lazy(() =>
  LazyRetry(() => import("./src/page/client/Detail/DetailContainer"))
);
const ProductContainer = lazy(() =>
  LazyRetry(() => import("./src/page/client/Product/ProductContainer"))
);
const CustomerLoginContainer = lazy(() =>
  LazyRetry(() => import("./src/page/client/login/LoginContainer"))
);
const ProfileContainer = lazy(() =>
  LazyRetry(() => import("./src/page/client/profile/ProfileContainer"))
);

const CustomerOrderContainer = lazy(() =>
  LazyRetry(() => import("./src/page/client/profile/order/OrderContainer"))
);
...
const CustomerInfoContainer = lazy(() =>
  LazyRetry(() => import("./src/page/client/profile/info/InfoContainer"))
);

const CustomerAddressContainer = lazy(() =>
  LazyRetry(() => import("./src/page/client/profile/address/AddressContainer"))
);
const App = () => {
  ...
  const getCart = () => {
    axiosClient
      ...
      .catch(({ response }) => {
        setStatus({
          type: "error",
          message: response?.data ? response.data.message : "Server error",
        });
      });
  };
            ...
            <Routes>
              <Route path="/" element={<Outlet />}>
                ...
                <Route path="admin/*" element={<AdminLayout />}>
                  ...
                  <Route path="group-category" element={<Outlet />}>
                    <Route
                      index
                      element={
                        <Suspense fallback={<Loading />}>
